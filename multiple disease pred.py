...
diabetes_model = pickle.load(open(
    'F:\Multiple Disease Prediction System\saved models\diabetes_model.sav', 'rb'))

heart_disease_model = pickle.load(open(
    'F:\Multiple Disease Prediction System\saved models\heart_disease_model.sav', 'rb'))

parkinsons_model = pickle.load(open(
    'F:\Multiple Disease Prediction System\saved models\parkinsons_model.sav', 'rb'))
